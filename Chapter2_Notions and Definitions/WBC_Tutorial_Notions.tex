...
\textcolor{red}{\textsl{White-box diversity}} (WB-div) counts in how many distinct ways a particular unencoded lookup table can be encoded by randomly and independently chosen permutations.
...
For key-dependent lookup tables, the variation of the embedded key-material needs to be taken into account.
}
